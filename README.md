...
- **scrutineer** — CLI tool that scans open PRs/MRs across GitLab and GitHub, reviews them via a pluggable engine (in-process LLM agent or external command), and posts findings as comments.
